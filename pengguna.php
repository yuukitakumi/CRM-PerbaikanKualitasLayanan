...
<div class="btn-customer">
    <button class="button button10" type="submit" name="simpan">Save</button><button class="button button10" type="reset">Reset</button><a href="pengguna.php" class="button button10">Refresh</a>
</div>
    ...
    while($data = mysqli_fetch_array($query)){
        ?>
            <tr>
                ...
                <td>
                    <a href="pengguna.php?aksi=update&id_pengguna=<?php echo $data['id_pengguna'];?>&nama=<?php echo $data['nama']; ?>?>&jabatan=<?php echo $data['jabatan']; ?>?>?>&password=<?php echo $data['password']; ?>">Edit</a> |
                    <a href="pengguna.php?aksi=delete&id_pengguna=<?php echo $data['id_pengguna']; ?>"onclick="return confirm('Yakin ingin di Hapus?')">Hapus</a>
                </td>
            </tr>
        <?php
    }
...
function ubah($conn){
    ...
    <tr> 
<div class="btn-customer">
    <button class="button button10" type="submit" name="btn_ubah" id="btn_ubah">Update</button><a href="pengguna.php" class="button button10">Refresh</a> <a href="pengguna.php?aksi=delete&pengguna=<?php echo $_GET['id_pengguna'] ?>" class="button button10">Hapus data ini</a>
</div>
...
if (isset($_GET['aksi'])){
    switch($_GET['aksi']){
        case "create":
            echo '<a href="pengguna.php"> &laquo; Home</a>';
            tambah($conn); 
            break;
        case "read":
            tampil_data($conn);
